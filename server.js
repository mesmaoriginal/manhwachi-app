...
app.post("/purchase/request", async (req, res) => {
  try {
    ...
    // به همین دلیل ترتیب کار اینه:
    // ۱) اول تراکنش رو در زیبال می‌سازیم (با یک orderId موقت چون هنوز رکورد
    //    payments وجود نداره و id‌ای در کار نیست) - یعنی انتقال به درگاه
    //    اصلاً به Supabase گره نخورده و بدون تماس با Supabase انجام می‌شه.
    ...
    // ساخت تراکنش در زیبال (بدون هیچ تماسی با Supabase)
    ...
    // فقط حالا که زیبال موفق بود، رکورد pending رو یکجا و کامل می‌سازیم
